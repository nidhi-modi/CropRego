...
var numberWeek;
var myBoolen;
export default class Har4Avalantino extends Component {
    constructor(props) {
        super(props)
    ...
    callQuery= () => {
        ...
        setTimeout(() => {
            db.plantsByWeekRowNumberAndName("1", numberWeek, 'HAR 4 - Avalantino','426').then((data) => {
                console.log(data);
        ...
        setTimeout(() => {
            db.plantsByWeekRowNumberAndName("2", numberWeek, 'HAR 4 - Avalantino','426').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet2: 1,
        ...
        setTimeout(() => {
            db.plantsByWeekRowNumberAndName("3", numberWeek, 'HAR 4 - Avalantino','426').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet3: 1,
        ...
        setTimeout(() => {
            db.plantsByWeekRowNumberAndName("4", numberWeek, 'HAR 4 - Avalantino','426').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet4: 1,
        ...
        setTimeout(() => {
            db.plantsByWeekRowNumberAndName("5", numberWeek, 'HAR 4 - Avalantino','426').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet5: 1,
                ...
                <ImageBackground source={require('../assets/background2.png')} style={styles.backgroundImage}>
                    ...
                    <ScrollView>
                        ...
                        {this.state.dataSet2 !== 1 ? (
                            <TouchableOpacity
                                style={styles.buttonContainer}
                                onPress={() => this.props.navigation.navigate('Har4AvalantinoPlant', { plant2: 2 })}>
                        ...
                        {this.state.dataSet3 !== 1 ? (
                            <TouchableOpacity
                                style={styles.buttonContainer}
                                onPress={() => this.props.navigation.navigate('Har4AvalantinoPlant', { plant3: 3 })}>
                        ...
                        {this.state.dataSet4 !== 1 ? (
                            <TouchableOpacity
                                style={styles.buttonContainer}
                                onPress={() => this.props.navigation.navigate('Har4AvalantinoPlant', { plant4: 4 })}>
                        ...
                        {this.state.dataSet5 !== 1 ? (
                            <TouchableOpacity
                                style={styles.buttonContainer}
                                onPress={() => this.props.navigation.navigate('Har4AvalantinoPlant', { plant5: 5 })}>
