...
import { StyleSheet, View, Text, TextInput, TouchableOpacity, Image, ImageBackground, Alert, ActivityIndicator } from 'react-native'
...
export default class SiteSelection extends React.Component {
  ...
  harAlertButton = () => {
    Alert.alert(
      ...
      [
        { text: 'Yes', onPress: () => this.props.navigation.navigate('Home', { site1: 'HAR' }) },
  ...
  gerAlertButton = () => {
    Alert.alert(
      ...
      'It cannot be changed',
      [
        { text: 'Yes', onPress: () => this.props.navigation.navigate('Home', { site1: 'GER' }) },
        { text: 'No', onPress: () => console.log('No button clicked'), style: 'cancel' },
      ],
      {
        cancelable: false
  ...
  favAlertButton = () => {
    Alert.alert(
      ...
      'It cannot be changed',
      [
        { text: 'Yes', onPress: () => this.props.navigation.navigate('Home', { site1: 'FAV' }) },
        { text: 'No', onPress: () => console.log('No button clicked'), style: 'cancel' },
      ],
      {
        cancelable: false
  ...
  ohaAlertButton = () => {
    Alert.alert(
      ...
      'It cannot be changed',
      [
        { text: 'Yes', onPress: () => this.props.navigation.navigate('Home', { site1: 'OHA' }) },
        { text: 'No', onPress: () => console.log('No button clicked'), style: 'cancel' },
      ],
      {
        cancelable: false
