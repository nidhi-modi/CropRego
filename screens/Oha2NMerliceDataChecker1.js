...
export default class Oha2NMerliceDataChecker1 extends React.Component {
  ...
  componentDidMount() {
    ...
    setTimeout(() => {
      ...
      db.trussByWeekNumberRowAndName2(number, numberWeek, 'OHA 2N - Merlice', '93').then((data) => {
        console.log(data);
    ...
    setTimeout(() => {
      ...
      db.trussByWeekNumberRowAndName2(number, numberWeek1, 'OHA 2N - Merlice', '93').then((data) => {
        console.log(data);
        console.log("Calling database")
        truss2 = data;
        this.setState({
    ...
    setTimeout(() => {
      ...
      db.trussByWeekNumberRowAndName2(number, numberWeek2, 'OHA 2N - Merlice', '93').then((data) => {
        console.log(data);
        console.log("Calling database")
        truss3 = data;
        this.setState({
    ...
    setTimeout(() => {
      ...
      db.trussByWeekNumberRowAndName2(number, numberWeek3, 'OHA 2N - Merlice', '93').then((data) => {
        console.log(data);
        console.log("Calling database")
        truss4 = data;
        this.setState({
