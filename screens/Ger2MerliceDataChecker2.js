...
export default class Ger2MerliceDataChecker2 extends React.Component {
  ...
  componentDidMount() {
    ...
    setTimeout(() => {
      ...
      db.trussByWeekNumberRowAndName2(number, numberWeek, 'GER 2 - Merlice', '114/115').then((data) => {
        console.log(data);
    ...
    setTimeout(() => {
      ...
      db.trussByWeekNumberRowAndName2(number, numberWeek1, 'GER 2 - Merlice', '114/115').then((data) => {
        console.log(data);
        console.log("Calling database")
        truss2 = data;
        this.setState({
    ...
    setTimeout(() => {
      ...
      db.trussByWeekNumberRowAndName2(number, numberWeek2, 'GER 2 - Merlice', '114/115').then((data) => {
        console.log(data);
        console.log("Calling database")
        truss3 = data;
        this.setState({
    ...
    setTimeout(() => {
      ...
      db.trussByWeekNumberRowAndName2(number, numberWeek3, 'GER 2 - Merlice', '114/115').then((data) => {
        console.log(data);
        console.log("Calling database")
        truss4 = data;
        this.setState({
