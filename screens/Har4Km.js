...
var numberWeek;
var myBoolen;
export default class Har4Km extends Component {
    constructor(props) {
        super(props)
                    ...
                    <ScrollView>
                        ...
                        {this.state.dataSet1 !== 1 ? (
                            <TouchableOpacity
                                ...
                                onPress={() => this.props.navigation.navigate('Har4KmPlant1', { plant1: 1 })}>
                        ...
                        {this.state.dataSet2 !== 1 ? (
                            <TouchableOpacity
                                style={styles.buttonContainer}
                                onPress={() => this.props.navigation.navigate('Har4KmPlant1', { plant2: 2 })}>
                        ...
                        {this.state.dataSet3 !== 1 ? (
                            <TouchableOpacity
                                style={styles.buttonContainer}
                                onPress={() => this.props.navigation.navigate('Har4KmPlant1', { plant3: 3 })}>
                        ...
                        {this.state.dataSet4 !== 1 ? (
                            <TouchableOpacity
                                style={styles.buttonContainer}
                                onPress={() => this.props.navigation.navigate('Har4KmPlant1', { plant4: 4 })}>
                        ...
                        {this.state.dataSet5 !== 1 ? (
                            <TouchableOpacity
                                style={styles.buttonContainer}
                                onPress={() => this.props.navigation.navigate('Har4KmPlant1', { plant5: 5 })}>
