...
export default class Ger5AngelleDataChecker3 extends React.Component {
  ...
  componentDidMount() {
    ...
    setTimeout(() => {
      ...
      db.trussByWeekNumberRowAndName2(number, numberWeek, 'GER 5 - Angelle', '48').then((data) => {
        console.log(data);
    ...
    setTimeout(() => {
      ...
      db.trussByWeekNumberRowAndName2(number, numberWeek1, 'GER 5 - Angelle', '48').then((data) => {
        console.log(data);
        console.log("Calling database")
        truss2 = data;
        this.setState({
    ...
    setTimeout(() => {
      ...
      db.trussByWeekNumberRowAndName2(number, numberWeek2, 'GER 5 - Angelle', '48').then((data) => {
        console.log(data);
        console.log("Calling database")
        truss3 = data;
        this.setState({
    ...
    setTimeout(() => {
      ...
      db.trussByWeekNumberRowAndName2(number, numberWeek3, 'GER 5 - Angelle', '48').then((data) => {
        console.log(data);
        console.log("Calling database")
        truss4 = data;
        this.setState({
