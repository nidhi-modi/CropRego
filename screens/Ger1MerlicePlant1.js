...
export default class Ger1MerlicePlant1 extends Component {
    ...
    componentDidMount() {
        ...
        if (no1 !== undefined && no1 !== null) {
            ...
            db.plantsByWeekRowAndName(no1, numberWeek-1 , 'GER 1 - Merlice', '45/46').then((data) => {
                console.log(data);
                    ...
                    <ImageBackground source={require('../assets/T&G_Tomatoes.jpg')} style={styles.backgroundImage}>
                        ...
                        <ScrollView style={styles.formContainer}
                            ...
                            <Text style={styles.text} onChangeText={(text) => this.updateTextInput(text, 'plantRow')}
                                value={this.state.plantRow}>Row Number 45/46</Text>
