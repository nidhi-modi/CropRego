...
export default class RepMerlice extends Component {
    ...
    callQuery = () => {
        ...
        setTimeout(() => {
            db.plantsByWeekRowNumberAndName("1", numberWeek, 'REP - Merlice', '222').then((data) => {
                console.log(data);
        ...
        setTimeout(() => {
            db.plantsByWeekRowNumberAndName("2", numberWeek, 'REP - Merlice', '222').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet2: 1,
        ...
        setTimeout(() => {
            db.plantsByWeekRowNumberAndName("3", numberWeek, 'REP - Merlice', '222').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet3: 1,
        ...
        setTimeout(() => {
            db.plantsByWeekRowNumberAndName("4", numberWeek, 'REP - Merlice', '222').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet4: 1,
        ...
        setTimeout(() => {
            db.plantsByWeekRowNumberAndName("5", numberWeek, 'REP - Merlice', '222').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet5: 1,
        ...
        setTimeout(() => {
            db.plantsByWeekRowNumberAndName("6", numberWeek, 'REP - Merlice', '222').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet6: 1,
        ...
        setTimeout(() => {
            db.plantsByWeekRowNumberAndName("7", numberWeek, 'REP - Merlice', '222').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet7: 1,
        ...
        setTimeout(() => {
            db.plantsByWeekRowNumberAndName("8", numberWeek, 'REP - Merlice', '222').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet8: 1,
        ...
        setTimeout(() => {
            db.plantsByWeekRowNumberAndName("9", numberWeek, 'REP - Merlice', '222').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet9: 1,
        ...
        setTimeout(() => {
            db.plantsByWeekRowNumberAndName("10", numberWeek, 'REP - Merlice', '222').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet10: 1,
