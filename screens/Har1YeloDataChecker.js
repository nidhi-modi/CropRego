...
export default class Har1YeloDataChecker extends React.Component {
  ...
  componentDidMount() {
    ...
    setTimeout(() => {
      ...
      db.plantsByWeekNumberAndName(number, numberWeek2, 'HAR 1 - Yelo').then((data) => {
        console.log(data);
        console.log("Calling database")
        plantNo2 = data;
        this.setState({
    ...
    setTimeout(() => {
      ...
      db.plantsByWeekNumberAndName(number, numberWeek3, 'HAR 1 - Yelo').then((data) => {
        console.log(data);
        console.log("Calling database")
        plantNo3 = data;
        this.setState({
    ...
    setTimeout(() => {
      ...
      db.plantsByWeekNumberAndName(number, numberWeek, 'HAR 1 - Yelo').then((data) => {
        console.log(data);
        console.log("Calling database")
        plantNo4 = data;
        this.setState({
