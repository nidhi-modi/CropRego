...
export default class Har1Yelo extends Component {
    ...
    callQuery= () => {
        ...
        setTimeout(() => {
            db.plantsByWeekNumberAndName("1", numberWeek, 'HAR 1 - Yelo').then((data) => {
                console.log(data);
        ...
        setTimeout(() => {
            db.plantsByWeekNumberAndName("2", numberWeek, 'HAR 1 - Yelo').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet2: 1,
        ...
        setTimeout(() => {
            db.plantsByWeekNumberAndName("3", numberWeek, 'HAR 1 - Yelo').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet3: 1,
        ...
        setTimeout(() => {
            db.plantsByWeekNumberAndName("4", numberWeek, 'HAR 1 - Yelo').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet4: 1,
        ...
        setTimeout(() => {
            db.plantsByWeekNumberAndName("5", numberWeek, 'HAR 1 - Yelo').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet5: 1,
                    ...
                    <ScrollView>
                        ...
                        {this.state.dataSet1 !== 1 ? (
                            <TouchableOpacity
                                ...
                                onPress={() => this.props.navigation.navigate('Har1YeloPlant1', { plant1: 1 })}>
                        ...
                        {this.state.dataSet2 !== 1 ? (
                            <TouchableOpacity
                                style={styles.buttonContainer}
                                onPress={() => this.props.navigation.navigate('Har1YeloPlant1', { plant2: 2 })}>
                        ...
                        {this.state.dataSet3 !== 1 ? (
                            <TouchableOpacity
                                style={styles.buttonContainer}
                                onPress={() => this.props.navigation.navigate('Har1YeloPlant1', { plant3: 3 })}>
                        ...
                        {this.state.dataSet4 !== 1 ? (
                            <TouchableOpacity
                                style={styles.buttonContainer}
                                onPress={() => this.props.navigation.navigate('Har1YeloPlant1', { plant4: 4 })}>
                        ...
                        {this.state.dataSet5 !== 1 ? (
                            <TouchableOpacity
                                style={styles.buttonContainer}
                                onPress={() => this.props.navigation.navigate('Har1YeloPlant1', { plant5: 5 })}>
