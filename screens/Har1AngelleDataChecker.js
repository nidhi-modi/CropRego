...
export default class Har1AngelleDataChecker extends React.Component {
  ...
  componentDidMount() {
    ...
    setTimeout(() => {
      ...
      db.trussByWeekNumberAndName(number, numberWeek, 'HAR 1 - Angelle').then((data) => {
        console.log(data);
    ...
    setTimeout(() => {
      ...
      db.trussByWeekNumberAndName(number, numberWeek1, 'HAR 1 - Angelle').then((data) => {
        console.log(data);
        console.log("Calling database")
        truss2 = data;
        this.setState({
    ...
    setTimeout(() => {
      ...
      db.trussByWeekNumberAndName(number, numberWeek2, 'HAR 1 - Angelle').then((data) => {
        console.log(data);
        console.log("Calling database")
        truss3 = data;
        this.setState({
    ...
    setTimeout(() => {
      ...
      db.trussByWeekNumberAndName(number, numberWeek3, 'HAR 1 - Angelle').then((data) => {
        console.log(data);
        console.log("Calling database")
        truss4 = data;
        this.setState({
    ...
    setTimeout(() => {
      ...
      db.plantsByWeekNumberAndName(number, numberWeek1, 'HAR 1 - Angelle').then((data) => {
        console.log(data);
        console.log("Calling database")
        plantNo1 = data;
        this.setState({
    ...
    setTimeout(() => {
      ...
      db.plantsByWeekNumberAndName(number, numberWeek2, 'HAR 1 - Angelle').then((data) => {
        console.log(data);
        console.log("Calling database")
        plantNo2 = data;
        this.setState({
    ...
    setTimeout(() => {
      ...
      db.plantsByWeekNumberAndName(number, numberWeek3, 'HAR 1 - Angelle').then((data) => {
        console.log(data);
        console.log("Calling database")
        plantNo3 = data;
        this.setState({
    ...
    setTimeout(() => {
      ...
      db.plantsByWeekNumberAndName(number, numberWeek, 'HAR 1 - Angelle').then((data) => {
        console.log(data);
        console.log("Calling database")
        plantNo4 = data;
        this.setState({
