...
export default class RepMerlice2Plant2 extends React.Component {
    ...
    savePlantsToDbAlert = () => {
        ...
        if (this.state.isError) {
            ...
            Alert.alert(
                ...
                [
                    { text: 'No', onPress: () => this.props.navigation.navigate('RepMerlice2DataChecker2', { plantNo: no }), style: 'cancel' },
