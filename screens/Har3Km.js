...
export default class Har3Km extends Component {
    ...
    callQuery= () => {
        ...
        setTimeout(() => {
            db.plantsByWeekRowNumberAndName("1", numberWeek, 'HAR 3 - KM5512','323').then((data) => {
                console.log(data);
        ...
        setTimeout(() => {
            db.plantsByWeekRowNumberAndName("2", numberWeek, 'HAR 3 - KM5512','323').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet2: 1,
        ...
        setTimeout(() => {
            db.plantsByWeekRowNumberAndName("3", numberWeek, 'HAR 3 - KM5512','323').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet3: 1,
        ...
        setTimeout(() => {
            db.plantsByWeekRowNumberAndName("4", numberWeek, 'HAR 3 - KM5512','323').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet4: 1,
        ...
        setTimeout(() => {
            db.plantsByWeekRowNumberAndName("5", numberWeek, 'HAR 3 - KM5512','323').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet5: 1,
