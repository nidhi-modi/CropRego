...
export default class Har3AngelleTrussDetails1 extends React.Component {
    ...
    getTrussData = () => {
        ...
        if (this.state.trussNumber != null) {
            ...
            db.trussByIdRow(this.state.trussNumber, numberWeek - 1, 'HAR 3 - Angelle', number, '323').then((data) => {
                console.log(data);
        ...
        setTimeout(() => {
            ...
            if ((parseInt(this.state.trussNumber) + 1) != null) {
                ...
                db.trussByIdRow((parseInt(this.state.trussNumber) + 1), numberWeek - 1, 'HAR 3 - Angelle', number, '323').then((data1) => {
                    console.log(data1);
                    console.log("Calling database")
                    truss1 = data1;
                    this.setState({
        ...
        setTimeout(() => {
            if ((parseInt(this.state.trussNumber) + 2) != null) {
                ...
                db.trussByIdRow((parseInt(this.state.trussNumber) + 2), numberWeek - 1, 'HAR 3 - Angelle', number, '323').then((data2) => {
                    console.log(data2);
                    console.log("Calling database")
                    truss2 = data2;
                    this.setState({
        ...
        setTimeout(() => {
            if ((parseInt(this.state.trussNumber) + 3) != null) {
                ...
                db.trussByIdRow((parseInt(this.state.trussNumber) + 3), numberWeek - 1, 'HAR 3 - Angelle', number, '323').then((data3) => {
                    console.log(data3);
                    console.log("Calling database")
                    truss3 = data3;
                    this.setState({
        ...
        setTimeout(() => {
            if ((parseInt(this.state.trussNumber) + 4) != null) {
                ...
                db.trussByIdRow((parseInt(this.state.trussNumber) + 4), numberWeek - 1, 'HAR 3 - Angelle', number, '323').then((data4) => {
                    console.log(data4);
                    console.log("Calling database")
                    truss4 = data4;
                    this.setState({
        ...
        setTimeout(() => {
            ...
            if ((parseInt(this.state.trussNumber) + 5) != null) {
                ...
                db.trussByIdRow((parseInt(this.state.trussNumber) + 5), numberWeek - 1, 'HAR 3 - Angelle', number, '323').then((data5) => {
                    console.log(data5);
                    console.log("Calling database")
                    truss5 = data5;
                    this.setState({
        ...
        setTimeout(() => {
            ...
            if ((parseInt(this.state.trussNumber) + 6) != null) {
                ...
                db.trussByIdRow((parseInt(this.state.trussNumber) + 6), numberWeek - 1, 'HAR 3 - Angelle', number, '323').then((data6) => {
                    console.log(data6);
                    console.log("Calling database")
                    truss6 = data6;
                    this.setState({
        ...
        setTimeout(() => {
            ...
            if ((parseInt(this.state.trussNumber) + 7) != null) {
                ...
                db.trussByIdRow((parseInt(this.state.trussNumber) + 7), numberWeek - 1, 'HAR 3 - Angelle', number, '323').then((data7) => {
                    console.log(data7);
                    console.log("Calling database")
                    truss7 = data7;
                    this.setState({
        ...
        setTimeout(() => {
            ...
            if ((parseInt(this.state.trussNumber) + 8) != null) {
                ...
                db.trussByIdRow((parseInt(this.state.trussNumber) + 8), numberWeek - 1, 'HAR 3 - Angelle', number, '323').then((data8) => {
                    console.log(data8);
                    console.log("Calling database")
                    truss8 = data8;
                    this.setState({
        ...
        setTimeout(() => {
            ...
            if ((parseInt(this.state.trussNumber) + 9) != null) {
                ...
                db.trussByIdRow((parseInt(this.state.trussNumber) + 9), numberWeek - 1, 'HAR 3 - Angelle', number, '323').then((data9) => {
                    console.log(data9);
                    console.log("Calling database")
                    truss9 = data9;
                    this.setState({
        ...
        if (this.state.trussNumber !== null && this.state.pruningNumber !== null) {
            ...
            if (this.state.isItConnected === 'Online') {
                ...
                db.addTrussDetails(dataSend11).then((result) => {
                    ...
                    const url = `${scriptUrl}?
                    callback=ctrlq&plantRow=${'323'}&plantName=${'HAR 3 - Angelle'}&plantWeek=${numberWeek}&plantNumber=${number}&trussNumber=${this.state.trussNumber}&setFruits=${this.state.setFruits}&setFlowers=${this.state.setFlowers}&pruningNumber=${this.state.pruningNumber}&fruitLoad=${this.state.fruitLoad}&fruitDiameter=${this.state.fruitDiameter}&pruningFlower=${this.state.pruneFlowering}&floweringTruss=${this.state.floweringTrussss}&pruningSet=${this.state.prunSetting}&settingTruss=${this.state.settingTrussNumber}&pruningHarvest=${this.state.pruningHar}&harvestTruss=${this.state.harvestTruss}`;
                    ...
                    fetch(url, { mode: 'no-cors' }).then((response) => {
                        ...
                        if (response.status === 200) {
                            ...
                            if ((parseInt(this.state.trussNumber) + 1) !== null && this.state.pruningNumber1 !== '') {
                                ...
                                this.props.navigation.navigate('Har3AngellePlant1')
        ...
        if ((parseInt(this.state.trussNumber) + 1) != null && this.state.pruningNumber1 !== null) {
            ...
            if (this.state.isItConnected === 'Online') {
                ...
                db.addTrussDetails(data1Send).then((result) => {
                    ...
                    const scriptUrl = 'https://script.google.com/macros/s/AKfycbyrhjbdlQyOSiORQG6ATubxi7PM6vZL8oP27EJFewR5LFgTn6fD/exec';
                    const url = `${scriptUrl}?
                    callback=ctrlq&plantRow=${'323'}&plantName=${'HAR 3 - Angelle'}&plantWeek=${numberWeek}&plantNumber=${number}&trussNumber=${parseInt(this.state.trussNumber) + 1}&setFruits=${this.state.setFruits1}&setFlowers=${this.state.setFlowers1}&pruningNumber=${this.state.pruningNumber1}&fruitLoad=${this.state.fruitLoad}&fruitDiameter=${this.state.fruitDiameter}&pruningFlower=${this.state.pruneFlowering}&floweringTruss=${this.state.floweringTrussss}&pruningSet=${this.state.prunSetting}&settingTruss=${this.state.settingTrussNumber}&pruningHarvest=${this.state.pruningHar}&harvestTruss=${this.state.harvestTruss}`;
        ...
        if ((parseInt(this.state.trussNumber) + 2) != null && this.state.pruningNumber2 !== null) {
            ...
            if (this.state.isItConnected === 'Online') {
                ...
                db.addTrussDetails(data2Send).then((result) => {
                    ...
                    const scriptUrl = 'https://script.google.com/macros/s/AKfycbyrhjbdlQyOSiORQG6ATubxi7PM6vZL8oP27EJFewR5LFgTn6fD/exec';
                    const url = `${scriptUrl}?
                    callback=ctrlq&plantRow=${'323'}&plantName=${'HAR 3 - Angelle'}&plantWeek=${numberWeek}&plantNumber=${number}&trussNumber=${parseInt(this.state.trussNumber) + 2}&setFruits=${this.state.setFruits2}&setFlowers=${this.state.setFlowers2}&pruningNumber=${this.state.pruningNumber2}&fruitLoad=${this.state.fruitLoad}&fruitDiameter=${this.state.fruitDiameter}&pruningFlower=${this.state.pruneFlowering}&floweringTruss=${this.state.floweringTrussss}&pruningSet=${this.state.prunSetting}&settingTruss=${this.state.settingTrussNumber}&pruningHarvest=${this.state.pruningHar}&harvestTruss=${this.state.harvestTruss}`;
        ...
        if ((parseInt(this.state.trussNumber) + 3) !== null && this.state.pruningNumber3 !== null) {
            ...
            if (this.state.isItConnected === 'Online') {
                ...
                db.addTrussDetails(data3Send).then((result) => {
                    ...
                    const scriptUrl = 'https://script.google.com/macros/s/AKfycbyrhjbdlQyOSiORQG6ATubxi7PM6vZL8oP27EJFewR5LFgTn6fD/exec';
                    const url = `${scriptUrl}?
                    callback=ctrlq&plantRow=${'323'}&plantName=${'HAR 3 - Angelle'}&plantWeek=${numberWeek}&plantNumber=${number}&trussNumber=${parseInt(this.state.trussNumber) + 3}&setFruits=${this.state.setFruits3}&setFlowers=${this.state.setFlowers3}&pruningNumber=${this.state.pruningNumber3}&fruitLoad=${this.state.fruitLoad}&fruitDiameter=${this.state.fruitDiameter}&pruningFlower=${this.state.pruneFlowering}&floweringTruss=${this.state.floweringTrussss}&pruningSet=${this.state.prunSetting}&settingTruss=${this.state.settingTrussNumber}&pruningHarvest=${this.state.pruningHar}&harvestTruss=${this.state.harvestTruss}`;
        ...
        if ((parseInt(this.state.trussNumber) + 4) != null && this.state.pruningNumber4 !== null) {
            ...
            if (this.state.isItConnected === 'Online') {
                ...
                db.addTrussDetails(data4Send).then((result) => {
                    ...
                    const scriptUrl = 'https://script.google.com/macros/s/AKfycbyrhjbdlQyOSiORQG6ATubxi7PM6vZL8oP27EJFewR5LFgTn6fD/exec';
                    const url = `${scriptUrl}?
                    callback=ctrlq&plantRow=${'323'}&plantName=${'HAR 3 - Angelle'}&plantWeek=${numberWeek}&plantNumber=${number}&trussNumber=${parseInt(this.state.trussNumber) + 4}&setFruits=${this.state.setFruits4}&setFlowers=${this.state.setFlowers4}&pruningNumber=${this.state.pruningNumber4}&fruitLoad=${this.state.fruitLoad}&fruitDiameter=${this.state.fruitDiameter}&pruningFlower=${this.state.pruneFlowering}&floweringTruss=${this.state.floweringTrussss}&pruningSet=${this.state.prunSetting}&settingTruss=${this.state.settingTrussNumber}&pruningHarvest=${this.state.pruningHar}&harvestTruss=${this.state.harvestTruss}`;
        ...
        if ((parseInt(this.state.trussNumber) + 5) != null && this.state.pruningNumber5 !== null) {
            ...
            if (this.state.isItConnected === 'Online') {
                ...
                db.addTrussDetails(data5Send).then((result) => {
                    ...
                    const scriptUrl = 'https://script.google.com/macros/s/AKfycbyrhjbdlQyOSiORQG6ATubxi7PM6vZL8oP27EJFewR5LFgTn6fD/exec';
                    const url = `${scriptUrl}?
                    callback=ctrlq&plantRow=${'323'}&plantName=${'HAR 3 - Angelle'}&plantWeek=${numberWeek}&plantNumber=${number}&trussNumber=${parseInt(this.state.trussNumber) + 5}&setFruits=${this.state.setFruits5}&setFlowers=${this.state.setFlowers5}&pruningNumber=${this.state.pruningNumber5}&fruitLoad=${this.state.fruitLoad}&fruitDiameter=${this.state.fruitDiameter}&pruningFlower=${this.state.pruneFlowering}&floweringTruss=${this.state.floweringTrussss}&pruningSet=${this.state.prunSetting}&settingTruss=${this.state.settingTrussNumber}&pruningHarvest=${this.state.pruningHar}&harvestTruss=${this.state.harvestTruss}`;
        ...
        if ((parseInt(this.state.trussNumber) + 6) != null && this.state.pruningNumber6 !== null) {
            ...
            if (this.state.isItConnected === 'Online') {
                ...
                db.addTrussDetails(data6Send).then((result) => {
                    ...
                    const scriptUrl = 'https://script.google.com/macros/s/AKfycbyrhjbdlQyOSiORQG6ATubxi7PM6vZL8oP27EJFewR5LFgTn6fD/exec';
                    const url = `${scriptUrl}?
                    callback=ctrlq&plantRow=${'323'}&plantName=${'HAR 3 - Angelle'}&plantWeek=${numberWeek}&plantNumber=${number}&trussNumber=${parseInt(this.state.trussNumber) + 6}&setFruits=${this.state.setFruits6}&setFlowers=${this.state.setFlowers6}&pruningNumber=${this.state.pruningNumber6}&fruitLoad=${this.state.fruitLoad}&fruitDiameter=${this.state.fruitDiameter}&pruningFlower=${this.state.pruneFlowering}&floweringTruss=${this.state.floweringTrussss}&pruningSet=${this.state.prunSetting}&settingTruss=${this.state.settingTrussNumber}&pruningHarvest=${this.state.pruningHar}&harvestTruss=${this.state.harvestTruss}`;
        ...
        if ((parseInt(this.state.trussNumber) + 7) != null && this.state.pruningNumber7 !== null) {
            ...
            if (this.state.isItConnected === 'Online') {
                ...
                db.addTrussDetails(data7Send).then((result) => {
                    ...
                    const scriptUrl = 'https://script.google.com/macros/s/AKfycbyrhjbdlQyOSiORQG6ATubxi7PM6vZL8oP27EJFewR5LFgTn6fD/exec';
                    const url = `${scriptUrl}?
                    callback=ctrlq&plantRow=${'323'}&plantName=${'HAR 3 - Angelle'}&plantWeek=${numberWeek}&plantNumber=${number}&trussNumber=${parseInt(this.state.trussNumber) + 7}&setFruits=${this.state.setFruits7}&setFlowers=${this.state.setFlowers7}&pruningNumber=${this.state.pruningNumber7}&fruitLoad=${this.state.fruitLoad}&fruitDiameter=${this.state.fruitDiameter}&pruningFlower=${this.state.pruneFlowering}&floweringTruss=${this.state.floweringTrussss}&pruningSet=${this.state.prunSetting}&settingTruss=${this.state.settingTrussNumber}&pruningHarvest=${this.state.pruningHar}&harvestTruss=${this.state.harvestTruss}`;
        ...
        if ((parseInt(this.state.trussNumber) + 8) != null && this.state.pruningNumber8 !== null) {
            ...
            if (this.state.isItConnected === 'Online') {
                ...
                db.addTrussDetails(data8Send).then((result) => {
                    ...
                    const scriptUrl = 'https://script.google.com/macros/s/AKfycbyrhjbdlQyOSiORQG6ATubxi7PM6vZL8oP27EJFewR5LFgTn6fD/exec';
                    const url = `${scriptUrl}?
                    callback=ctrlq&plantRow=${'323'}&plantName=${'HAR 3 - Angelle'}&plantWeek=${numberWeek}&plantNumber=${number}&trussNumber=${parseInt(this.state.trussNumber) + 8}&setFruits=${this.state.setFruits8}&setFlowers=${this.state.setFlowers8}&pruningNumber=${this.state.pruningNumber8}&fruitLoad=${this.state.fruitLoad}&fruitDiameter=${this.state.fruitDiameter}&pruningFlower=${this.state.pruneFlowering}&floweringTruss=${this.state.floweringTrussss}&pruningSet=${this.state.prunSetting}&settingTruss=${this.state.settingTrussNumber}&pruningHarvest=${this.state.pruningHar}&harvestTruss=${this.state.harvestTruss}`;
        ...
        if ((parseInt(this.state.trussNumber) + 9) != null && this.state.pruningNumber9 !== null) {
            ...
            if (this.state.isItConnected === 'Online') {
                ...
                db.addTrussDetails(data9Send).then((result) => {
                    ...
                    const scriptUrl = 'https://script.google.com/macros/s/AKfycbyrhjbdlQyOSiORQG6ATubxi7PM6vZL8oP27EJFewR5LFgTn6fD/exec';
                    const url = `${scriptUrl}?
                        callback=ctrlq&plantRow=${'323'}&plantName=${'HAR 3 - Angelle'}&plantWeek=${numberWeek}&plantNumber=${number}&trussNumber=${parseInt(this.state.trussNumber) + 9}&setFruits=${this.state.setFruits9}&setFlowers=${this.state.setFlowers9}&pruningNumber=${this.state.pruningNumber9}&fruitLoad=${this.state.fruitLoad}&fruitDiameter=${this.state.fruitDiameter}&pruningFlower=${this.state.pruneFlowering}&floweringTruss=${this.state.floweringTrussss}&pruningSet=${this.state.prunSetting}&settingTruss=${this.state.settingTrussNumber}&pruningHarvest=${this.state.pruningHar}&harvestTruss=${this.state.harvestTruss}`;
