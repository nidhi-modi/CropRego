...
var numberWeek;
var myBoolen;
export default class Har1Angelle extends Component {
    constructor(props) {
        super(props)
    ...
    callQuery= () => {
        ...
        setTimeout(() => {
            db.plantsByWeekNumberAndName("1", numberWeek, 'HAR 1 - Angelle').then((data) => {
                console.log(data);
        ...
        setTimeout(() => {
            db.plantsByWeekNumberAndName("2", numberWeek, 'HAR 1 - Angelle').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet2: 1,
        ...
        setTimeout(() => {
            db.plantsByWeekNumberAndName("3", numberWeek, 'HAR 1 - Angelle').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet3: 1,
        ...
        setTimeout(() => {
            db.plantsByWeekNumberAndName("4", numberWeek, 'HAR 1 - Angelle').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet4: 1,
        ...
        setTimeout(() => {
            db.plantsByWeekNumberAndName("5", numberWeek, 'HAR 1 - Angelle').then((data) => {
                console.log(data);
                console.log("Calling database")
                this.setState({
                    dataSet5: 1,
                    ...
                    <ScrollView>
                        ...
                        {this.state.dataSet1 !== 1 ? (
                            <TouchableOpacity
                                ...
                                onPress={() => this.props.navigation.navigate('Har1AngellePlant1', { plant1: 1 })}>
                        ...
                        {this.state.dataSet2 !== 1 ? (
                            <TouchableOpacity
                                style={styles.buttonContainer}
                                onPress={() => this.props.navigation.navigate('Har1AngellePlant1', { plant2: 2 })}>
                        ...
                        {this.state.dataSet3 !== 1 ? (
                            <TouchableOpacity
                                style={styles.buttonContainer}
                                onPress={() => this.props.navigation.navigate('Har1AngellePlant1', { plant3: 3 })}>
                        ...
                        {this.state.dataSet4 !== 1 ? (
                            <TouchableOpacity
                                style={styles.buttonContainer}
                                onPress={() => this.props.navigation.navigate('Har1AngellePlant1', { plant4: 4 })}>
                        ...
                        {this.state.dataSet5 !== 1 ? (
                            <TouchableOpacity
                                style={styles.buttonContainer}
                                onPress={() => this.props.navigation.navigate('Har1AngellePlant1', { plant5: 5 })}>
