...
export default class RepMerliceTrussDetails1 extends React.Component {
    ...
    getTrussData = () => {
        ...
        if (this.state.trussNumber != null) {
            ...
            db.trussById(this.state.trussNumber, numberWeek - 1, 'REP - Merlice', number, '222').then((data) => {
                console.log(data);
        ...
        setTimeout(() => {
            if ((parseInt(this.state.trussNumber) + 2) != null) {
                ...
                db.trussById((parseInt(this.state.trussNumber) + 2), numberWeek - 1, 'REP - Merlice', number, '222').then((data2) => {
                    console.log(data2);
                    console.log("Calling database")
                    truss2 = data2;
                    this.setState({
        ...
        setTimeout(() => {
            if ((parseInt(this.state.trussNumber) + 3) != null) {
                ...
                db.trussById((parseInt(this.state.trussNumber) + 3), numberWeek - 1, 'REP - Merlice', number, '222').then((data3) => {
                    console.log(data3);
                    console.log("Calling database")
                    truss3 = data3;
                    this.setState({
        ...
        setTimeout(() => {
            if ((parseInt(this.state.trussNumber) + 4) != null) {
                ...
                db.trussById((parseInt(this.state.trussNumber) + 4), numberWeek - 1, 'REP - Merlice', number, '222').then((data4) => {
                    console.log(data4);
                    console.log("Calling database")
                    truss4 = data4;
                    this.setState({
        ...
        setTimeout(() => {
            ...
            if ((parseInt(this.state.trussNumber) + 5) != null) {
                ...
                db.trussById((parseInt(this.state.trussNumber) + 5), numberWeek - 1, 'REP - Merlice', number, '222').then((data5) => {
                    console.log(data5);
                    console.log("Calling database")
                    truss5 = data5;
                    this.setState({
        ...
        setTimeout(() => {
            ...
            if ((parseInt(this.state.trussNumber) + 6) != null) {
                ...
                db.trussById((parseInt(this.state.trussNumber) + 6), numberWeek - 1, 'REP - Merlice', number, '222').then((data6) => {
                    console.log(data6);
                    console.log("Calling database")
                    truss6 = data6;
                    this.setState({
        ...
        setTimeout(() => {
            ...
            if ((parseInt(this.state.trussNumber) + 7) != null) {
                ...
                db.trussById((parseInt(this.state.trussNumber) + 7), numberWeek - 1, 'REP - Merlice', number, '222').then((data7) => {
                    console.log(data7);
                    console.log("Calling database")
                    truss7 = data7;
                    this.setState({
        ...
        setTimeout(() => {
            ...
            if ((parseInt(this.state.trussNumber) + 8) != null) {
                ...
                db.trussById((parseInt(this.state.trussNumber) + 8), numberWeek - 1, 'REP - Merlice', number, '222').then((data8) => {
                    console.log(data8);
                    console.log("Calling database")
                    truss8 = data8;
                    this.setState({
        ...
        setTimeout(() => {
            ...
            if ((parseInt(this.state.trussNumber) + 9) != null) {
                ...
                db.trussById((parseInt(this.state.trussNumber) + 9), numberWeek - 1, 'REP - Merlice', number, '222').then((data9) => {
                    console.log(data9);
                    console.log("Calling database")
                    truss9 = data9;
                    this.setState({
